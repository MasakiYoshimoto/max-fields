<?php /* Smarty version 2.6.27, created on 2018-09-05 17:40:17
         compiled from /var/www/vhosts/evolve-max.com/httpdocs/cake_app/control/plugins/job2/views/job2_offers//add_conf.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'yen', '/var/www/vhosts/evolve-max.com/httpdocs/cake_app/control/plugins/job2/views/job2_offers//add_conf.html', 76, false),array('modifier', 'escape', '/var/www/vhosts/evolve-max.com/httpdocs/cake_app/control/plugins/job2/views/job2_offers//add_conf.html', 76, false),array('modifier', 'nl2br', '/var/www/vhosts/evolve-max.com/httpdocs/cake_app/control/plugins/job2/views/job2_offers//add_conf.html', 76, false),)), $this); ?>
...
<div class="cont">
<?php echo $this->_tpl_vars['form']->create('Job2Offer',$this->_tpl_vars['this']->aa('action','/adddo','name','job2_offers','Autocomplete','off')); ?>
...
&nbsp;
    ...
    <tr>
        ...
        <td width="72%"><?php if ($this->_tpl_vars['input']['pic1']): ?><a href="<?php echo $this->_tpl_vars['file_temp_url']; ?>
<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['input']['pic1'])) ? $this->_run_mod_handler('yen', true, $_tmp) : smarty_modifier_yen($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'utf-8') : smarty_modifier_escape($_tmp, 'html', 'utf-8')); ?>
" rel="sexylightbox" target="_blank"><img border="0" src="<?php echo $this->_tpl_vars['file_temp_url']; ?>
<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['input']['pic1'])) ? $this->_run_mod_handler('yen', true, $_tmp) : smarty_modifier_yen($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'utf-8') : smarty_modifier_escape($_tmp, 'html', 'utf-8')); ?>
...
<?php echo $this->_tpl_vars['form']->create('Job2Offer',$this->_tpl_vars['this']->aa('action','/adddo','name','doc_return')); ?>
