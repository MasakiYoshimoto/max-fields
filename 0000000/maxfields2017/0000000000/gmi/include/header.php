...
<link rel="stylesheet" href="<?php echo ROOT_PATH?>gmi/css/gmi.css">
...
<div id="siteHeader">
	<div id="siteHeaderInner">
		<div id="siteHeaderTop">
			<h1 id="siteHeaderLogo"><a href="<?php echo ROOT_PATH?>gmi/"><img src="<?php echo ROOT_PATH?>gmi/img/header_logo.png" alt="株式会社グローバルマックスインブルーメンツ" width="346" height="55"></a></h1>
			<div id="siteHeaderContact">
				<a class="contact" href="<?php echo ROOT_PATH?>gmi/contact/">お問い合わせ</a>
			</div>
		</div>
		<div id="siteHeaderNav">
			<ul>
				<li><a href="<?php echo ROOT_PATH?>gmi/">ホーム</a></li>
				<li><a href="<?php echo ROOT_PATH?>gmi/info/">インフォメーション</a></li>
			</ul>
		</div>
	</div><!--/#siteHeaderInner-->
</div><!--/#siteHeader-->
...
<div id="siteNav" class="gmi02">
	<ul>
		<li><a href="<?php echo ROOT_PATH?>gmi/about/">GMIとは</a></li>
		<li><a href="<?php echo ROOT_PATH?>gmi/about/#anchor-outline">会社概要</a></li>
		<li><a href="<?php echo ROOT_PATH?>gmi/employer/">企業ご担当者の皆様</a></li>
		<li><a href="<?php echo ROOT_PATH?>gmi/employee/">働く皆様</a></li>
		<li><a href="<?php echo ROOT_PATH?>gmi/employee/2.html">保険制度・基礎研修・フォロー制度</a></li>
