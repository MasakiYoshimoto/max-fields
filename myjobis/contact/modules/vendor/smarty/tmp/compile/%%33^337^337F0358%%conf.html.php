<?php /* Smarty version 2.6.27, created on 2015-05-26 11:07:45
         compiled from /var/www/vhosts/evolve-max.com/httpdocs/myjobis/contact/modules/tpl/conf.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'nl2br', '/var/www/vhosts/evolve-max.com/httpdocs/myjobis/contact/modules/tpl/conf.html', 72, false),)), $this); ?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
<br />
				...
				<dt scope="row">お問い合わせ内容</dt>
				<dd>
                    <?php echo ((is_array($_tmp=$this->_tpl_vars['conf']['contents'])) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>

                </dd>
			</dl>
			<div class="btnwrap">
                <form action="./" method="post" name="form1" id="form3" style="display: inline">
...
" />
                ...
                <form action="./" method="post" name="form1" id="form2" style="display: inline">
