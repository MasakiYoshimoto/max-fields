<?php /* Smarty version 2.6.27, created on 2018-09-07 17:24:18
         compiled from /var/www/vhosts/evolve-max.com/httpdocs/cake_app/control/plugins/job2/views/job2_offers//edit_conf.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'yen', '/var/www/vhosts/evolve-max.com/httpdocs/cake_app/control/plugins/job2/views/job2_offers//edit_conf.html', 77, false),array('modifier', 'escape', '/var/www/vhosts/evolve-max.com/httpdocs/cake_app/control/plugins/job2/views/job2_offers//edit_conf.html', 77, false),array('modifier', 'nl2br', '/var/www/vhosts/evolve-max.com/httpdocs/cake_app/control/plugins/job2/views/job2_offers//edit_conf.html', 77, false),)), $this); ?>
...
<div class="cont">
<?php echo $this->_tpl_vars['form']->create('Job2Offer',$this->_tpl_vars['this']->aa('action','/editdo','name','job2_offers','Autocomplete','off')); ?>

<?php echo $this->_tpl_vars['form']->hidden('mode',$this->_tpl_vars['this']->aa('value','up')); ?>

<?php echo $this->_tpl_vars['form']->hidden('_token',$this->_tpl_vars['this']->aa('value',$this->_tpl_vars['token'])); ?>

<?php if ($this->_tpl_vars['input']['del_pic1']): ?> <?php $this->assign('pic1', ''); ?> <?php else: ?><?php if ($this->_tpl_vars['input']['pic1_up']): ?> <?php $this->assign('pic1', ($this->_tpl_vars['file_temp_url']).($this->_tpl_vars['input']['pic1'])); ?> <?php elseif ($this->_tpl_vars['original']['pic1']): ?> <?php $this->assign('pic1', ($this->_tpl_vars['image_url']).($this->_tpl_vars['original']['pic1'])); ?> <?php endif; ?><?php endif; ?>
...
&nbsp;</td>
    ...
    <tr>
        ...
        <td width="72%">
            <?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['input']['category'])) ? $this->_run_mod_handler('yen', true, $_tmp) : smarty_modifier_yen($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'utf-8') : smarty_modifier_escape($_tmp, 'html', 'utf-8')))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
&nbsp;
        </td>
    </tr>
    <tr>
...
&nbsp;
    ...
    <tr>
        <td width="28%" class="clr">画像</td>
        <td width="72%"><?php if ($this->_tpl_vars['pic1']): ?><a href="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['pic1'])) ? $this->_run_mod_handler('yen', true, $_tmp) : smarty_modifier_yen($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'utf-8') : smarty_modifier_escape($_tmp, 'html', 'utf-8')); ?>
" rel="sexylightbox" target="_blank"><img border="0" src="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['pic1'])) ? $this->_run_mod_handler('yen', true, $_tmp) : smarty_modifier_yen($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'utf-8') : smarty_modifier_escape($_tmp, 'html', 'utf-8')); ?>
" width="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['input']['pic1_w'])) ? $this->_run_mod_handler('yen', true, $_tmp) : smarty_modifier_yen($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'utf-8') : smarty_modifier_escape($_tmp, 'html', 'utf-8')); ?>
" height="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['input']['pic1_h'])) ? $this->_run_mod_handler('yen', true, $_tmp) : smarty_modifier_yen($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'utf-8') : smarty_modifier_escape($_tmp, 'html', 'utf-8')); ?>
...
<?php echo $this->_tpl_vars['form']->create('Job2Offer',$this->_tpl_vars['this']->aa('action','/editdo','name','doc_return')); ?>
...
" width="93" height="27" alt="登　録" style="cursor: pointer" onclick="document.job2_offers.submit();" /> 　<img src="<?php echo $this->_tpl_vars['html']->webroot('images/modoru_btn.jpg'); ?>
