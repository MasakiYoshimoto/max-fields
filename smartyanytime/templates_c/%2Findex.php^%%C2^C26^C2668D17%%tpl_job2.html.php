...
<?php $this->_cache_serials['/var/www/vhosts/evolve-max.com/httpdocs/smartyanytime/templates_c//%2Findex.php^%%C2^C26^C2668D17%%tpl_job2.html.inc'] = '563745d9ef1b6733e968965ffb489246'; ?><!DOCTYPE html>
<html lang="ja">
<head>
...
<div id="container" class="clearfix">
    <?php if ($this->caching && !$this->_cache_including): echo '{nocache:563745d9ef1b6733e968965ffb489246#0}'; endif;echo smartyanytime_plugins_job::job_list(array('job' => $_GET['job'],'area' => $_GET['area'],'search_null' => true,'max' => 16), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:563745d9ef1b6733e968965ffb489246#0}'; endif;?>

	<div id="main" class="tableRow"><div class="spcellwrap"><!-- Start-Page_Content -->
        <h2><img src="img/job_h2_02.gif" width="152" height="21" alt="検索結果" /></h2>
        
        <?php if ($this->_tpl_vars['job']['count'] != 0): ?>
        <div class="pagenation clearfix">
	        <div class="left"><p>全<span class="resultnum"><?php echo $this->_tpl_vars['job']['count']; ?>
</span>件中 <?php echo $this->_tpl_vars['job']['start']; ?>
～<?php echo $this->_tpl_vars['job']['end']; ?>
件を表示</p></div>
	        <div class="right">
		        <ul>
                    <?php if ($this->_tpl_vars['job']['page'] != 1): ?>
                    <li class="previous"><a href="./job2.html?p=<?php echo $this->_tpl_vars['job']['page']-1; ?>
...
?>
                    <?php if ($this->_tpl_vars['job']['page'] == $this->_tpl_vars['value']): ?>
					    <li class="current"><?php echo $this->_tpl_vars['value']; ?>
</li>
                    <?php else: ?>
                        <li><a href="./job2.html?p=<?php echo $this->_tpl_vars['value']; ?>
<?php echo $this->_tpl_vars['job']['search_query']; ?>
"><?php echo $this->_tpl_vars['value']; ?>
</a></li>
                    <?php endif; ?>
                    <?php endforeach; endif; unset($_from); ?>
                    <?php if ($this->_tpl_vars['job']['page'] != $this->_tpl_vars['job']['maxpage']): ?>
		            <li class="next"><a href="./job2.html?p=<?php echo $this->_tpl_vars['job']['page']+1; ?>
<?php echo $this->_tpl_vars['job']['search_query']; ?>
">次へ</a></li>
                    <?php endif; ?>
		        </ul>
...
.gif" width="140" height="20" alt="<?php echo $this->_tpl_vars['area_list'][$this->_tpl_vars['value']['location']]; ?>
" />
