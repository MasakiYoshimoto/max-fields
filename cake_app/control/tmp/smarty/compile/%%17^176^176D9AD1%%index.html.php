<?php /* Smarty version 2.6.27, created on 2015-10-16 20:48:11
         compiled from /var/www/vhosts/evolve-max.com/httpdocs/cake_app/control/plugins/raptrecommended/views/raptrecommended_pages//index.html */ ?>
...
<div class="cont pageList">
<h4>動作環境</h4>
<ul style='margin-top: 10px;margin-left: 10px;'>
    <li>InternetExplorer　7～9</li>
    <li>Mozilla Firefox　8 以降</li>
    <li>Safari 5.1 以降</li>
    <li>Google Chrome</li>
</ul>
<h4 style='margin-top: 10px;'>推奨環境</h4>
<ul style='margin-top: 10px;margin-left: 10px;'>
<li>InternetExplorer　7～9</li>
<li>Mozilla Firefox　最新</li>
</ul>
<!--<h5 style='margin-top: 20px;'>推奨環境以外のブラウザでは以下の動作を行うことが出来ません。</h5>-->
<!--<div style='margin-top:10px;font-size: 90%'>-->
<!--<strong>【エディタ】</strong><br/>-->
<!--・ドラグによる画像のサイズの変更-->
