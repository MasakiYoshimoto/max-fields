...
<link rel="stylesheet" href="<?php echo ROOT_PATH?>sophiamax/css/gmi.css">
...
<div id="siteHeader">
	<div id="siteHeaderInner">
		<div id="siteHeaderTop">
			<h1 id="siteHeaderLogo"><a href="<?php echo ROOT_PATH?>sophiamax/"><img src="<?php echo ROOT_PATH?>sophiamax/img/header_logo.png" alt="株式会社ソフィアマックス" height="55"></a></h1>
			<div id="siteHeaderContact">
				<a class="contact" href="<?php echo ROOT_PATH?>sophiamax/contact/">お問い合わせ</a>
			</div>
		</div>
		<div id="siteHeaderNav">
			<ul>
				<li><a href="<?php echo ROOT_PATH?>sophiamax/">ホーム</a></li>
				<li><a href="<?php echo ROOT_PATH?>sophiamax/info/">インフォメーション</a></li>
			</ul>
		</div>
	</div><!--/#siteHeaderInner-->
</div><!--/#siteHeader-->
...
<div id="siteNav" class="gmi02">
	<ul>
		<li><a href="<?php echo ROOT_PATH?>sophiamax/about/">ソフィアマックスとは</a></li>
		<li><a href="<?php echo ROOT_PATH?>sophiamax/about/#anchor-outline">会社概要</a></li>
		<li><a href="<?php echo ROOT_PATH?>sophiamax/employer/">企業ご担当者の皆様</a></li>
		<li><a href="<?php echo ROOT_PATH?>sophiamax/employee/">働く皆様</a></li>
		<li><a href="<?php echo ROOT_PATH?>sophiamax/employee/2.html">保険制度・基礎研修・フォロー制度</a></li>
		<li><a href="<?php echo ROOT_PATH?>sophiamax/jinzai/">人材派遣事業</a></li>
	</ul>
</div><!--/#siteNav-->