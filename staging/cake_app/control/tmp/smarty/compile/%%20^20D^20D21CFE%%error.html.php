<?php /* Smarty version 2.6.27, created on 2018-08-09 11:05:10
         compiled from /var/www/vhosts/evolve-max.com/httpdocs/cake_app/control/views/users//error.html */ ?>
...
<p id="mainTitle">サイト管理画面 / エラー</p>

<p>ログインIDもしくはパスワードが間違っています</p>
<br />
<br />
<a href="<?php echo $this->_tpl_vars['html']->webroot(''); ?>
"><img src="<?php echo $this->_tpl_vars['html']->webroot('images/login_btn.jpg'); ?>
" width="93" height="27" alt="ログイン" /></a></div>
