...
?>
        <tr>
            <td <?php if ($this->_tpl_vars['value']['JobOffer']['disable']): ?>bgcolor="#d3d3d3"<?php elseif ($this->_tpl_vars['value']['JobOffer']['status'] == 1): ?>bgcolor="#ccffcc"<?php elseif ($this->_tpl_vars['value']['JobOffer']['status'] == 2): ?>bgcolor="#ffcccc"<?php endif; ?>><?php if ($this->_tpl_vars['value']['JobOffer']['company']): ?>&lt;<?php echo $this->_tpl_vars['value']['JobOffer']['company']; ?>
&gt;<?php endif; ?><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['value']['JobOffer']['catchcopy'])) ? $this->_run_mod_handler('trim', true, $_tmp) : trim($_tmp)))) ? $this->_run_mod_handler('mb_truncate', true, $_tmp, 40) : smarty_modifier_mb_truncate($_tmp, 40)))) ? $this->_run_mod_handler('yen', true, $_tmp) : smarty_modifier_yen($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'utf-8') : smarty_modifier_escape($_tmp, 'html', 'utf-8')); ?>
</td>
            <td <?php if ($this->_tpl_vars['value']['JobOffer']['disable']): ?>bgcolor="#d3d3d3"<?php elseif ($this->_tpl_vars['value']['JobOffer']['status'] == 1): ?>bgcolor="#ccffcc"<?php elseif ($this->_tpl_vars['value']['JobOffer']['status'] == 2): ?>bgcolor="#ffcccc"<?php endif; ?>><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['value']['JobOffer']['reg_date'])) ? $this->_run_mod_handler('d_format', true, $_tmp, 'Y/m/d') : smarty_modifier_d_format($_tmp, 'Y/m/d')))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'utf-8') : smarty_modifier_escape($_tmp, 'html', 'utf-8')); ?>
</td>
            <td <?php if ($this->_tpl_vars['value']['JobOffer']['disable']): ?>bgcolor="#d3d3d3"<?php elseif ($this->_tpl_vars['value']['JobOffer']['status'] == 1): ?>bgcolor="#ccffcc"<?php elseif ($this->_tpl_vars['value']['JobOffer']['status'] == 2): ?>bgcolor="#ffcccc"<?php endif; ?>><img src="<?php echo $this->_tpl_vars['html']->webroot('images/edit_icon.jpg'); ?>
" width="40" height="19" alt="編集"  style="cursor: pointer" onclick="offer_edit( <?php echo $this->_tpl_vars['value']['JobOffer']['id']; ?>
 );" />&nbsp;<img src="<?php echo $this->_tpl_vars['html']->webroot('images/delete_icon.jpg'); ?>
" width="40" height="19" alt="削除"  style="cursor: pointer" onclick="offer_del( <?php echo $this->_tpl_vars['value']['JobOffer']['id']; ?>
 );" /></td>
        </tr>
...
job/job_offers/index/page:<?php echo $this->_tpl_vars['value']['page']; ?>
...
<?php echo $this->_tpl_vars['form']->create('JobOffer',$this->_tpl_vars['this']->aa('action','/add','name','add')); ?>

</form>
<?php echo $this->_tpl_vars['form']->create('JobOffer',$this->_tpl_vars['this']->aa('action','/edit','name','edit')); ?>

<?php echo $this->_tpl_vars['form']->hidden('id',$this->_tpl_vars['this']->aa('value','')); ?>

</form>
<?php echo $this->_tpl_vars['form']->create('JobOffer',$this->_tpl_vars['this']->aa('action','/del','name','del')); ?>
