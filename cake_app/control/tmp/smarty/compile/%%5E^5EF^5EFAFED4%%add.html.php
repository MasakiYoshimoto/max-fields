<?php /* Smarty version 2.6.27, created on 2018-02-23 14:09:15
         compiled from /var/www/vhosts/evolve-max.com/httpdocs/cake_app/control/views/cmsdocuments//add.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'preg_replace', '/var/www/vhosts/evolve-max.com/httpdocs/cake_app/control/views/cmsdocuments//add.html', 35, false),array('modifier', 'yen', '/var/www/vhosts/evolve-max.com/httpdocs/cake_app/control/views/cmsdocuments//add.html', 178, false),array('modifier', 'escape', '/var/www/vhosts/evolve-max.com/httpdocs/cake_app/control/views/cmsdocuments//add.html', 308, false),array('modifier', 'nl2br', '/var/www/vhosts/evolve-max.com/httpdocs/cake_app/control/views/cmsdocuments//add.html', 343, false),)), $this); ?>
...
?pre=1');
			...
			$('#doc').attr('action','<?php echo $this->_tpl_vars['html']->webroot("cmsdocuments/adddo"); ?>
');
...
<?php endif; ?>
<div class="cont">
<?php echo $this->_tpl_vars['form']->create('Cmsdocument',$this->_tpl_vars['this']->aa('action','/adddo','name','doc','id','doc','enctype','multipart/form-data')); ?>
...
&nbsp;<input type="button" value="ファイル選択" onclick="openKCFinder_singleFile('#directlink2');">
				<br/>
				<span class="redTxt">リンクさせるURLもしくはファイルを選択して下さい。(URLの方が優先されます)</span>
			<?php else: ?>
				<p>ファイル：</p><?php echo $this->_tpl_vars['form']->input('directlink2',$this->_tpl_vars['this']->aa('type','file','size','40','label','false','div','false','error','false')); ?>
    ...
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['value']):
?>
	<?php $this->assign('output', ((is_array($_tmp=$this->_tpl_vars['value']['Cmsitem']['input_value'])) ? $this->_run_mod_handler('yen', true, $_tmp) : smarty_modifier_yen($_tmp))); ?>
	<?php $this->assign('output2', ((is_array($_tmp=$this->_tpl_vars['value']['Cmsitem']['input_value'])) ? $this->_run_mod_handler('yen', true, $_tmp) : smarty_modifier_yen($_tmp))); ?>
	<tr>
		<td class="clr cont_td" <?php if ($this->_tpl_vars['value']['Cmsitem']['type'] == 2 && ( ! $this->_tpl_vars['use_tinymce'] || $this->_tpl_vars['use_fulledit'] )): ?>height="550"<?php endif; ?>><?php echo $this->_tpl_vars['value']['Cmsitem']['name']; ?>
...
');"><br/>
		...
		<?php echo $this->_tpl_vars['form']->radio($this->_tpl_vars['this']->cat('Cmsdocument.',$this->_tpl_vars['value']['Cmsitem']['variable_name']),$this->_tpl_vars['array'],$this->_tpl_vars['this']->aa('legend','false','separator','　','id','false','value',$this->_tpl_vars['value']['Cmsitem']['input_value'])); ?>

		<?php endif; ?>
		<?php if ($this->_tpl_vars['value']['Cmsitem']['type'] == 6): ?><?php echo $this->_tpl_vars['form']->select($this->_tpl_vars['this']->cat('Cmsdocument.',$this->_tpl_vars['value']['Cmsitem']['variable_name']),$this->_tpl_vars['this']->ss($this->_tpl_vars['value']['Cmsitem']['values_string']),$this->_tpl_vars['value']['Cmsitem']['input_value'],null,false); ?>
<?php endif; ?>
		<?php if ($this->_tpl_vars['value']['Cmsitem']['type'] == 7): ?>
		<?php $this->assign('array', $this->_tpl_vars['this']->ss($this->_tpl_vars['value']['Cmsitem']['values_string'])); ?>
		<?php $this->assign('selecton', $this->_tpl_vars['this']->ss($this->_tpl_vars['value']['Cmsitem']['input_value'])); ?>
...
<?php endif; ?>
		<?php if ($this->_tpl_vars['value']['Cmsitem']['explanation'] != ""): ?><br/><span class="redTxt"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['value']['Cmsitem']['explanation'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'utf-8') : smarty_modifier_escape($_tmp, 'html', 'utf-8')))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</span><?php endif; ?>
		</td>
	</tr>
	<?php endforeach; endif; unset($_from); ?>
