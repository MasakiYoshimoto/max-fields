<?php /* Smarty version 2.6.27, created on 2015-08-18 13:54:53
         compiled from /var/www/vhosts/evolve-max.com/httpdocs/cake_app/control/views/cmsdocuments//add_conf.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'yen', '/var/www/vhosts/evolve-max.com/httpdocs/cake_app/control/views/cmsdocuments//add_conf.html', 78, false),array('modifier', 'escape', '/var/www/vhosts/evolve-max.com/httpdocs/cake_app/control/views/cmsdocuments//add_conf.html', 78, false),array('modifier', 'nl2br', '/var/www/vhosts/evolve-max.com/httpdocs/cake_app/control/views/cmsdocuments//add_conf.html', 78, false),)), $this); ?>
...
<div class="cont">
<?php echo $this->_tpl_vars['form']->create('Cmsdocument',$this->_tpl_vars['this']->aa('action','/adddo','name','conf')); ?>
...
" target="_blank"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['input']['directlink'])) ? $this->_run_mod_handler('yen', true, $_tmp) : smarty_modifier_yen($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'utf-8') : smarty_modifier_escape($_tmp, 'html', 'utf-8')); ?>
			...
			<?php if ($this->_tpl_vars['input']['directlink_flag'] == 'file'): ?>
				<?php if ($this->_tpl_vars['use_filemanager']): ?>
					<A href="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['input']['directlink2'])) ? $this->_run_mod_handler('yen', true, $_tmp) : smarty_modifier_yen($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'utf-8') : smarty_modifier_escape($_tmp, 'html', 'utf-8')); ?>
			...
			<table style="border: none;">
				<tr>
					<td style="border: none;">
						<a href="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['value']['Cmsitem']['input_value'])) ? $this->_run_mod_handler('yen', true, $_tmp) : smarty_modifier_yen($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'utf-8') : smarty_modifier_escape($_tmp, 'html', 'utf-8')); ?>
" rel="sexylightbox" target="_blank">
							<img src="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['value']['Cmsitem']['input_value'])) ? $this->_run_mod_handler('yen', true, $_tmp) : smarty_modifier_yen($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'utf-8') : smarty_modifier_escape($_tmp, 'html', 'utf-8')); ?>
...
" />
					...
					<td style="border: none;">
						<span class="redTxt">※左のサムネイル画像をクリックされますと、<br/>実際の画像が表示、確認できます。</span>
					</td>
				</tr>
			</table>
...
<?php echo $this->_tpl_vars['form']->create('Cmsdocument',$this->_tpl_vars['this']->aa('action','/adddo','name','doc_return')); ?>
