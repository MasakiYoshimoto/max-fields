<?php
	define('JOB2_MAX_FILE_SIZE', 1048576);
	class Job2Offer extends Job2AppModel {
		var $name = 'Job2Offer';
									...
									'addconf' => array(
										...
										'work'=>array(
											...
											'rule1'=>array(
												...
												'last' => true,
												'allowEmpty' => true,
												'message'=>'仕事内容・職場紹介は1000文字以下でご入力下さい',
											),
										),
										'require_ability'=>array(
											...
											'rule1'=>array(
												...
												'last' => true,
												'allowEmpty' => true,
												'message'=>'必要な経験能力は1000文字以下でご入力下さい',
											),
										),
										...
										'pic1'=>array(
											'required'=>array(
												'required'=>true,
												'rule'=>array("imgupRequire"),
												'last' => true,
												'message'=>'画像を選択して下さい',
											),
											'rule1'=>array(
												'rule'=>array('checkimgfile',JOB2_MAX_FILE_SIZE,2000,2000),
												'on'=>null,
												'last' => true,
												'message'=>'画像のサイズが大きいか、ファイル形式が違う可能性があります',
											),
										),
									),
									'editconf' => array(
