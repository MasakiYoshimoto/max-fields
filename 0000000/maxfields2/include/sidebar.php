...
.html"><img src="<?php echo ROOT_PATH?>maxfields/img/sidebar/bnr_spdeco.jpg" alt="spdeco" width="230" height="140"></a>
	...
	<div class="sidebarBannar">
		<a href="http://career-pro.jp/"><img src="<?php echo ROOT_PATH?>maxfields/img/sidebar/bnr_careerpro.gif" alt="キャリプロ" width="230" height="100"></a>
	</div><!--/.sidebarBannar-->
	
	<div class="sidebarBannar">
		<a href="http://www.evolve-max.com/maxfields2/kyujin/"><img src="<?php echo ROOT_PATH?>maxfields2/img/sidebar/bnr_kyujin.gif" alt="マックスフィールズグループ求人一覧" width="230" height="120"></a>
	</div><!--/.sidebarBannar-->
