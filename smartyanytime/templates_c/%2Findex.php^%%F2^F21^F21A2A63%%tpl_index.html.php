...
<?php $this->_cache_serials['/var/www/vhosts/evolve-max.com/httpdocs/smartyanytime/templates_c//%2Findex.php^%%F2^F21^F21A2A63%%tpl_index.html.inc'] = '8b20b68ac546a85e787f515e04071e0b'; ?><?php 
		...
		<div class="contentBox">
			...
			<div class="mainHeader">
				...
				<p class="outTitle00">◎ 求人一覧</p>
                        <?php if ($this->caching && !$this->_cache_including): echo '{nocache:8b20b68ac546a85e787f515e04071e0b#0}'; endif;echo smartyanytime_plugins_job2::job2_list(array('job' => $_GET['job'],'area' => $_GET['area'],'search_null' => true,'max' => 9), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:8b20b68ac546a85e787f515e04071e0b#0}'; endif;?>
