<?php /* Smarty version 2.6.27, created on 2018-09-07 09:25:54
         compiled from /var/www/vhosts/evolve-max.com/httpdocs/cake_app/control/plugins/job2/views/job2_offers//add.html */ ?>
...
<?php endif; ?>
<div class="cont">
<?php echo $this->_tpl_vars['form']->create('Job2Offer',$this->_tpl_vars['this']->aa('action','/adddo','name','job2_offers','Autocomplete','off','enctype','multipart/form-data')); ?>
...
" width="40" height="19" alt="必須" /></td>
    ...
    <tr>
        ...
        <td width="72%"><?php echo $this->_tpl_vars['form']->select('Job2Offer.category',$this->_tpl_vars['job_category_list'],$this->_tpl_vars['input']['category'],null,false); ?>
</td>
    </tr>
    <tr>
