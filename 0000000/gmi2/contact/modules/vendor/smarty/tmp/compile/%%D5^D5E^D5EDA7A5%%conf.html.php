<?php /* Smarty version 2.6.27, created on 2013-08-08 15:24:37
         compiled from /var/www/vhosts/evolve-max.com/httpdocs/gmi/contact/modules/tpl/conf.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'nl2br', '/var/www/vhosts/evolve-max.com/httpdocs/gmi/contact/modules/tpl/conf.html', 82, false),)), $this); ?>
<?php 
define('PAGE_TITLE', 'お問い合わせ | 株式会社グローバルマックスインブルーメンツ');
define('PAGE_DESCRIPTION', 'グローバルマックスインブルーメンツへのお問い合わせ');
